...
class Ad(models.Model):
    ...
    content_type = models.CharField(max_length=256, null=True, help_text='The MIMETyp of the file')

    # Favorites
    favorites = models.ManyToManyField(settings.AUTH_USER_MODEL, through='Fav', related_name='favorite_ads')

    # Tag https://django-taggit.readthedocs.io/en/latest/api.html#TaggableManager
...
class Comment(models.Model):
    ...
    # Shows up in the admin list
    def __str__(self):
        if len(self.txt) < 15: return self.text
        return self.text[:11] + ' ...'
